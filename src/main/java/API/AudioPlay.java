...
public class AudioPlay {
    ...
    public static void TTS(String text) throws IOException, InterruptedException, UnsupportedAudioFileException, LineUnavailableException {
        String encodedText = URLEncoder.encode(text, "UTF-8");
        HttpRequest request = HttpRequest.newBuilder()
                .uri(URI.create("https://voicerss-text-to-speech.p.rapidapi.com/?key=a1ebb15a22fa42ca8ad9b87523d3648e&src="+encodedText+"&hl=en-us&r=0&c=WAV&f=22khz_8bit_mono"))
